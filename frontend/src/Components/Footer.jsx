    ...
    <div className="bg-[var(--LightBrown)] py-10 sticky top-[100vh]">
      ...
      <div className="flex flex-col gap-3 flex-grow text-center lg:text-left">
        ...
        <h2 className=" text-gray-600 ">
          <Link to="/" className="hover:text-white text-xl transition duration-300"><FontAwesomeIcon icon={faFacebook} /></Link>
        </h2>
        <h2 className=" text-gray-600 ">
          <Link to="/" className="hover:text-white text-xl transition duration-300"><FontAwesomeIcon icon={faTwitter} /></Link>
        </h2> 
        <h2 className=" text-gray-600 ">
          <Link to="/" className="hover:text-white text-xl transition duration-300"><FontAwesomeIcon icon={faInstagram} /></Link>
        </h2> 
        <h2 className=" text-gray-600 ">
          <Link to="/" className="hover:text-white text-xl transition duration-300"><FontAwesomeIcon icon={faLinkedin} /></Link>
        </h2>
        </div>
      </div> 
    </div>
