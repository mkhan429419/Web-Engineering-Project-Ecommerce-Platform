    ...
    <div className="flex flex-col justify-center items-center w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-[90%] max-w-[1200px]">
        ...
        <div className="flex flex-col justify-center items-start">
          <h1 className="text-3xl font-semibold mb-5 text-[var(--Brown)]">We are an ecommerce site</h1>
          <p className="text-justify text-lg text-[var(--Brown)] mb-10 ">
            ...
            quidem alias consequatur quia, aliquid perspiciatis modi voluptas, saepe repellendus 
            quo in odit at deserunt et dolorum asperiores corrupti eum.
          </p>
        </div>
      </div>
      <div className='bg-[var(--Light)] w-full'>
      <h1 className="font-bold text-3xl text-center text-[var(--Brown)] py-10">Our Services</h1>
          ...
          return <div key={index} className="block m-3 p-2 border rounded-md shadow-md cursor-pointer hover:scale-105 transition-all text-center">
             <div className="p-4 e">
              ...
              <FontAwesomeIcon icon={service.icon} className='h-7'/>
                  ...
                  <h2 className="text-lg font-semibold text-gray-700">{service.heading}</h2>
                  <h2 className="text-md text-gray-600 mt-2">{service.description}</h2>
              </div>
          </div>
      })
    }     </div>       
