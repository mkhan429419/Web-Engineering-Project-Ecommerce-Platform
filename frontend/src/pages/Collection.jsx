...
const Collection = () => {
    ...
    useEffect(() => {
        ...
        if (cat !== 'Default') {
          ...
          if (Subcat !== 'Default') {
            filteredCollection = filteredCollection.filter((item) => item.subCategory === Subcat);
          }

        if (sortOption === 'LowToHigh') {
            filteredCollection.sort((a, b) => getPriceValue(a.price.toString()) - getPriceValue(b.price.toString()));
        } else if (sortOption === 'HighToLow') {
            filteredCollection.sort((a, b) => getPriceValue(b.price.toString()) - getPriceValue(a.price.toString()));
        }
    ...
    return (
        <div className='bg-[var(--Light)]'>
            <div className='p-4 flex flex-wrap justify-between text-base'>
                ...
                <select className='bg-[var(--Light)] pr-10 pl-2  mr-2 text-[var(--Yellow)] border border-gray-400 rounded-md' value={Subcat}
